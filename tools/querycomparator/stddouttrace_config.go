...
func newConfig(options ...Option) tconfig {
	cfg := tconfig{
...
func (o writerOption) apply(cfg tconfig) tconfig {
	cfg.Writer = o.W
	return cfg
}
...
func (o prettyPrintOption) apply(cfg tconfig) tconfig {
...
func (o timestampsOption) apply(cfg tconfig) tconfig {
